...
export function CarouselProductLoading({ isLastItem }: { isLastItem: boolean }) {
  return (
    <div role="status" className={`shadow-md rounded-lg animate-pulse bg-custom-secondaryBrand ${isLastItem && "mr-3"} min-w-[225px] h-[387px] max-md:h-[375px] max-sm:h-[295px] max-sm:min-w-[185px]`}>
