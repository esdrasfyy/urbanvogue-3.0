...
export function InputSearch({ classname }: { classname: string }) {
  ...
  return (
    <form className={`relative ${classname} shadow-md rounded-full `} onSubmit={(e) => onSubmit(e)}>
      <div className={`relative w-full`}>
        ...
        <button type="submit" className="duration-300 absolute left-0 top-[50%] -translate-y-1/2 bg-custom-textColor text-custom-secondaryBrand hover-effect hover-opacity z-10 p-[6px] text-2xl rounded-full">
          <HiSearch />
        </button>
